...
import ModalDropdownButton from './modal-dropdown-button/ModalDropdownButton'
          ...
          <div className="row app-bg-dark-2 text-white p-2">
            ...
            <div className="col-1">
              ...
              <ModalDropdownButton
                ...
                modal={
                  <div>This is the modal dropdown for the Departments button</div>
                }
              />
            ...
            <div className="col-3">
              ...
              <ModalDropdownButton
                ...
                modal={
                  <div>This is the modal dropdown for the Account & Lists button</div>
                }
              />
